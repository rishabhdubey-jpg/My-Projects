...
function setupProjectsSection() {
  ...
  const PROJECTS = {
    'websites': {
      ...
      year: '2025-2026', tags: ['AI-SaaS', 'Full-Stack', 'UI/UX Clones', 'React', 'DOM Manipulation'],
      images: ['assets/images/projects/Covers/netflix.png', 'assets/images/projects/Covers/ultraedit.png', 'assets/images/projects/Covers/game.png'],
    },
    'visuals': {
      get desc() { return window.__t('project.visuals.desc'); },
      get category() { return window.__t('project.visuals.category'); },
      year: '2025-2026', tags: ['Clone', 'UI/UX', 'Design', 'After Effects', '3D Modeling'],
      images: ['assets/images/projects/Covers/ultraedit.png', 'assets/images/projects/Covers/game.png'],
    },
    'visuals_static': {
      get desc() { return window.__t('project.visuals_static.desc'); },
      get category() { return window.__t('project.visuals_static.category'); },
      year: '2026', tags: ['Digital Art', 'Photography', 'Color Grading'],
      images: ['assets/images/projects/Covers/visual.png'],
    },
  };
  ...
  function openProject(id, clickedItem) {
    ...
    if (driveBtn) {
      if (id === 'visuals') {
        ...
        driveBtn.href = "https://github.com/rishabhdubey-jpg";
        driveBtn.querySelector('span').textContent = window.__t('project.visuals.driveBtn') || 'View All Videos';
      } else if (id === 'visuals_static') {
        driveBtn.style.display = 'inline-flex';
        driveBtn.href = "assets/images/projects/Covers/visual.png";
        driveBtn.querySelector('span').textContent = window.__t('project.visuals_static.driveBtn') || 'View Full Resolution';
      } else {
    ...
    if (driveBtn && (id === 'visuals' || id === 'visuals_static')) {
